          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="col-span-3 flex justify-center md:col-span-2">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-neutral-50 text-neutral-300 transition-colors group-hover:bg-rose-50 group-hover:text-rose-400 md:h-16 md:w-16">
              ...
              <div className="col-span-9 md:col-span-6">
                <h3 className="text-4xl font-medium tracking-tight text-neutral-900 transition-colors group-hover:text-rose-500 md:text-6xl lg:text-7xl">
                  {feature.title}
                </h3>
              </div>
            </motion.div>
